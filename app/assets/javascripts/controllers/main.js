...
angular.module('azordens')
  .controller('MainCtrl', function($scope, $cookieStore, $window, $location, swalService) {
    $('select').selectpicker();
    ...
    $scope.showHints = function(showAnyway){
      var hintsShown = $cookieStore.get('hintsShown');
      if(!hintsShown || showAnyway){
        ...
        swal(
          {
            ...
            $cookieStore.put('hintsShown', true);
          }
        );
      }
    };
